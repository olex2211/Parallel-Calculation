...
- 🧑‍⚕️ **Patient Service:** [http://localhost/patient/docs](http://localhost/patient/docs)
- 📅 **Appointment Service:** [http://localhost/appointment/docs](http://localhost/appointment/docs)
- 💊 **Treatment Service:** [http://localhost/treatment/docs](http://localhost/treatment/docs)
- 💳 **Billing Service:** [http://localhost/billing/docs](http://localhost/billing/docs)
